...
if Rails.env.production?
  ...
  onboarding_key = if defined?(Redis::Alfred::ChusteRM_INSTALLATION_ONBOARDING)
...
unless Rails.env.production?
  ...
  CannedResponse.create!(account: account, short_code: 'start', content: 'Hello welcome to ChusteRM.')
end

load(Rails.root.join('db', 'seeds', 'crm_legal_pipeline.rb'))
