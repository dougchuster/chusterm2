        ...
        it 'returns nil if the plan is not default' do
          ...
          expected_response = {
            ...
            'limits' => {
              ...
              'conversation' => {},
              'captain' => {
                'documents' => { 'consumed' => 0, 'current_available' => ChusteRMApp.max_limit, 'total_count' => ChusteRMApp.max_limit },
                'responses' => { 'consumed' => 0, 'current_available' => ChusteRMApp.max_limit, 'total_count' => ChusteRMApp.max_limit }
              },
              'non_web_inboxes' => {}
            }
          }
