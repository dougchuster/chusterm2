    ...
    context 'when conversation exists' do
      ...
      context 'when handoff fails' do
        before do
          ...
          exception_tracker = instance_double(ChusteRMExceptionTracker)
        ...
        it 'captures exception' do
          exception_tracker = instance_double(ChusteRMExceptionTracker)
          expect(ChusteRMExceptionTracker).to receive(:new).with(instance_of(StandardError)).and_return(exception_tracker)
