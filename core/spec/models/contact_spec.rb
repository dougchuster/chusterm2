...
RSpec.describe Contact do
  ...
  describe '.resolved_contacts' do
    ...
    context 'when crm_v2 feature flag is enabled' do
      it 'returns CRM contacts with lead or customer contact types' do
        ...
        expect(resolved).to include(customer_contact)
        expect(resolved).not_to include(visitor_contact)
      end

      it 'includes all lead and customer contacts regardless of email/phone presence' do
