...
RSpec.describe Account do
  ...
  describe 'usage_limits' do
    ...
    it 'returns ChusteRMApp.max limits' do
      expect(account.usage_limits[:agents]).to eq(ChusteRMApp.max_limit)
      expect(account.usage_limits[:inboxes]).to eq(ChusteRMApp.max_limit)
    end
  end
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@chusterm.com')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@chusterm.com' do
        expect(account.support_email).to eq('support@chusterm.com')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@chusterm.com' do
        expect(account.support_email).to eq('hello@chusterm.com')
      end
    end
