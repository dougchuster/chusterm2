...
describe Whatsapp::IncomingMessageService do
  describe '#perform' do
    ...
    # ref: https://github.com/ChusteRM/ChusteRM/issues/3795#issuecomment-1018057318
    ...
    context 'when valid contact message params' do
      it 'creates appropriate message and attachments' do
        params = { 'contacts' => [{ 'profile' => { 'name' => 'Kedar' }, 'wa_id' => '919746334593' }],
                   'messages' => [{ 'from' => '919446284490',
                                    ...
                                    'contacts' => [
                                      ...
                                      { 'name' => { 'first_name' => 'ChusteRM', 'formatted_name' => 'ChusteRM' },
        ...
        expect(m2.content).to eq('ChusteRM')
        expect(m2.attachments.first.meta).to eq({ 'firstName' => 'ChusteRM' })
      end
    end

    # ref: https://github.com/ChusteRM/ChusteRM/issues/5840
