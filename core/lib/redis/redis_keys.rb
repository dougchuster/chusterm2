module Redis::RedisKeys
  ...
  ChusteRM_INSTALLATION_ONBOARDING = 'ChusteRM_INSTALLATION_ONBOARDING'.freeze
  ChusteRM_INSTALLATION_CONFIG_RESET_WARNING = 'ChusteRM_CONFIG_RESET_WARNING'.freeze
  LATEST_ChusteRM_VERSION = 'LATEST_ChusteRM_VERSION'.freeze
