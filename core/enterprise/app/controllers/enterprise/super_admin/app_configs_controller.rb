module Enterprise::SuperAdmin::AppConfigsController
  ...
  def allowed_configs
    return super if ChusteRMHub.pricing_plan == 'community'
  ...
  def internal_config_options
    %w[ChusteRM_INBOX_TOKEN ChusteRM_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY DASHBOARD_SCRIPTS INACTIVE_WHATSAPP_NUMBERS
       SKIP_INCOMING_BCC_PROCESSING CAPTAIN_CLOUD_PLAN_LIMITS ACCOUNT_SECURITY_NOTIFICATION_WEBHOOK_URL ChusteRM_INSTANCE_ADMIN_EMAIL
  ...
  def captain_config_options
    %w[
      ...
      CAPTAIN_MEDIA_AI_MODEL
      CAPTAIN_MEDIA_AI_FALLBACK_MODELS
      CAPTAIN_AUDIO_TRANSCRIPTION_MODEL
      CAPTAIN_AUDIO_TRANSCRIPTION_FALLBACK_MODELS
