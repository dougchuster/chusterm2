class Captain::Copilot::ChatService < Llm::BaseAiService
  ...
  def build_tools
    ...
    tools << Captain::Tools::Copilot::GetCrmContextService.new(@assistant, user: @user)
    ...
    tools << Captain::Tools::Copilot::MarketingSpendSummaryService.new(@assistant, user: @user)
    tools << Captain::Tools::Copilot::MarketingTopCampaignsService.new(@assistant, user: @user)
    tools << Captain::Tools::Copilot::MarketingLeadFunnelService.new(@assistant, user: @user)
