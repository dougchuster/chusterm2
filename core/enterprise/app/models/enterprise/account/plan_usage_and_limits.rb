module Enterprise::Account::PlanUsageAndLimits # rubocop:disable Metrics/ModuleLength
  ...
  def email_transcript_enabled?
    default_plan = InstallationConfig.find_by(name: 'ChusteRM_CLOUD_PLANS')&.value&.first
  ...
  def default_captain_limits
    max_limits = { documents: ChusteRMApp.max_limit, responses: ChusteRMApp.max_limit }.with_indifferent_access
