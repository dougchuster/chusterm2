...
module ChusteRM
  class Application < Rails::Application
    ...
    # Enterprise edition loading is controlled by DISABLE_ENTERPRISE env var
    # Default: enterprise is loaded (true = disabled, false = enabled)
    ENTERPRISE_DISABLED = ENV.fetch('DISABLE_ENTERPRISE', 'false') != 'false'
  ...
  def self.redis_ssl_verify_mode
    ...
    # ref: https://github.com/ChusteRM/ChusteRM/issues/2420
    #
