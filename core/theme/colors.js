...
export const colors = {
  ...
  // ── ChusteRM Design Tokens (camada semântica) ─────────────
  // Aliases das escalas Radix definidas em scss/_design-tokens.scss.
  // Componentes novos devem consumir SOMENTE esta escala (`ds-*`).
  ds: {
    bg: {
      canvas: 'rgb(var(--ds-bg-canvas) / <alpha-value>)',
      surface: 'rgb(var(--ds-bg-surface) / <alpha-value>)',
      elevated: 'rgb(var(--ds-bg-elevated) / <alpha-value>)',
      sunken: 'rgb(var(--ds-bg-sunken) / <alpha-value>)',
      hover: 'rgb(var(--ds-bg-hover) / <alpha-value>)',
      active: 'rgb(var(--ds-bg-active) / <alpha-value>)',
    },
    fg: {
      default: 'rgb(var(--ds-fg-default) / <alpha-value>)',
      muted: 'rgb(var(--ds-fg-muted) / <alpha-value>)',
      subtle: 'rgb(var(--ds-fg-subtle) / <alpha-value>)',
      disabled: 'rgb(var(--ds-fg-disabled) / <alpha-value>)',
      'on-accent': 'rgb(var(--ds-fg-on-accent) / <alpha-value>)',
    },
    border: {
    ...
    accent: {
      DEFAULT: 'rgb(var(--ds-accent-primary) / <alpha-value>)',
      hover: 'rgb(var(--ds-accent-primary-hover) / <alpha-value>)',
      active: 'rgb(var(--ds-accent-primary-active) / <alpha-value>)',
      soft: 'rgb(var(--ds-accent-primary-soft) / <alpha-value>)',
      secondary: 'rgb(var(--ds-accent-secondary) / <alpha-value>)',
      'secondary-hover':
        'rgb(var(--ds-accent-secondary-hover) / <alpha-value>)',
      'secondary-soft': 'rgb(var(--ds-accent-secondary-soft) / <alpha-value>)',
    },
    state: {
    ...
    shell: {
      ...
      panel: 'rgb(var(--ds-shell-panel) / <alpha-value>)',
      'panel-strong': 'rgb(var(--ds-shell-panel-strong) / <alpha-value>)',
      'panel-sunken': 'rgb(var(--ds-shell-panel-sunken) / <alpha-value>)',
      border: 'rgb(var(--ds-shell-border) / <alpha-value>)',
      divider: 'rgb(var(--ds-shell-divider) / <alpha-value>)',
      fg: 'rgb(var(--ds-shell-fg) / <alpha-value>)',
      muted: 'rgb(var(--ds-shell-muted) / <alpha-value>)',
      subtle: 'rgb(var(--ds-shell-subtle) / <alpha-value>)',
      accent: 'rgb(var(--ds-shell-accent) / <alpha-value>)',
      'accent-soft': 'rgb(var(--ds-shell-accent-soft) / <alpha-value>)',
      'accent-contrast': 'rgb(var(--ds-shell-accent-contrast) / <alpha-value>)',
      hover: 'rgb(var(--ds-shell-hover) / <alpha-value>)',
      active: 'rgb(var(--ds-shell-active) / <alpha-value>)',
      secondary: 'rgb(var(--ds-shell-secondary) / <alpha-value>)',
      'secondary-soft': 'rgb(var(--ds-shell-secondary-soft) / <alpha-value>)',
      warning: 'rgb(var(--ds-shell-warning) / <alpha-value>)',
      'warning-soft': 'rgb(var(--ds-shell-warning-soft) / <alpha-value>)',
      danger: 'rgb(var(--ds-shell-danger) / <alpha-value>)',
      'danger-soft': 'rgb(var(--ds-shell-danger-soft) / <alpha-value>)',
      focus: 'rgb(var(--ds-shell-focus) / <alpha-value>)',
    },
  },
};
