# This class creates both outgoing messages from ChusteRM and echo outgoing messages based on the flag `outgoing_echo`
# Assumptions
# 1. Incase of an outgoing message which is echo, source_id will NOT be nil,
#    based on this we are showing "not sent from ChusteRM" message in frontend
  ...
  def contact_params
    begin
      ...
      if e.message.include?('2018218')
        ...
        ChusteRMExceptionTracker.new(e, account: @inbox.account).capture_exception unless @outgoing_echo
      end
    rescue StandardError => e
      result = {}
      ChusteRMExceptionTracker.new(e, account: @inbox.account).capture_exception
