...
<template>
  <div class="flex flex-col w-full h-full min-h-0 bg-n-surface-1">
    <div class="flex w-full p-3 sm:p-4 shrink-0">
      <NextButton
    ...
    <section class="flex flex-col flex-grow w-full min-h-0 overflow-hidden">
      <div class="w-full max-w-5xl mx-auto z-30 shrink-0">
        <div class="flex flex-col w-full px-3 sm:px-4">
          <SearchHeader
      ...
      <div class="flex-grow w-full min-h-0 overflow-y-auto">
        <div class="w-full max-w-5xl mx-auto px-3 sm:px-4 pb-6">
