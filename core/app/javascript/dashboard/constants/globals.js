export default {
  ...
  DOCS_URL: 'https://www.chusterm.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.chusterm.com/docs/product/others/help-center',
  TESTIMONIAL_URL:
    'https://testimonials.cdn.chusterm.com/testimonial-content.json',
