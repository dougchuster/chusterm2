...
export default {
  ...
  mounted() {
    ...
    this.setLocale(
      this.uiSettings?.locale || window.chustermConfig.selectedLocale
    );
  },
  unmounted() {
  ...
  methods: {
    ...
    async initializeAccount() {
      ...
      const { locale, latest_chusterm_version: latestChusteRMVersion } =
        this.getAccount(this.currentAccountId);
      const { pubsub_token: pubsubToken } = this.currentUser || {};
      // If user locale is set, use it; otherwise use account locale
      this.setLocale(this.uiSettings?.locale || locale);
      this.latestChusteRMVersion = latestChusteRMVersion;
