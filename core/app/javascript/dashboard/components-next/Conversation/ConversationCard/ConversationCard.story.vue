...
const conversationWithoutMeta = {
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@chusterm.com',
      },
    },
    sender: {
      id: 1,
