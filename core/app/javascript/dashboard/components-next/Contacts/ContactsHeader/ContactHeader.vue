...
<template>
  <header class="sticky top-0 z-10 px-3 sm:px-6">
    <div
      class="flex flex-col items-stretch justify-between w-full gap-3 py-4 mx-auto sm:flex-row sm:items-center max-w-7xl sm:py-6"
    >
      <span class="text-xl font-medium truncate text-n-slate-12">
        {{ headerTitle }}
      </span>
      <div
        class="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:flex-shrink-0 sm:gap-4"
      >
        <div v-if="showSearch" class="flex items-center w-full gap-2 sm:w-72">
          <Input
        ...
        <div class="flex flex-wrap items-center flex-shrink-0 gap-3">
