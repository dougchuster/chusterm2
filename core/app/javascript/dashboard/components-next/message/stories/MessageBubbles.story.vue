...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about ChusteRM?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://ChusteRM.dev/invoice.pdf'),
      getAttachment('file', 'https://ChusteRM.dev/logs.txt'),
      getAttachment('file', 'https://ChusteRM.dev/contacts.xls'),
      getAttachment('file', 'https://ChusteRM.dev/customers.csv'),
      getAttachment('file', 'https://ChusteRM.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://ChusteRM.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://ChusteRM.dev/all-files.tar'),
      getAttachment(
        'audio',
