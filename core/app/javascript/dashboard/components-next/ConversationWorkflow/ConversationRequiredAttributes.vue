...
const { t } = useI18n();
const { currentAccount, accountId, isOnChusteRMCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnChusteRMCloud.value);
const i18nKey = computed(() =>
  isOnChusteRMCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
