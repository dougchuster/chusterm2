export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    trigger_rules: {
      url: 'https://www.chusterm.com/features/chatbot/',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://www.chusterm.com/pricings',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    message: 'Hi! ChusteRM here. Need help setting up? Let me know!',
    campaign_status: 'active',
    enabled: false,
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://{*.}?chusterm.com/apps/account/*/settings/inboxes/new/',
      time_on_page: 10,
    },
    trigger_only_during_business_hours: false,
