...
<template>
  <div
    class="flex gap-4 items-center px-4 py-2.5 w-full rounded-lg divide-x transition-colors bg-n-solid-1 outline outline-1 outline-ui-border-subtle hover:outline-n-slate-6 focus-within:outline-n-brand divide-ui-border-subtle/60"
  >
    <div
