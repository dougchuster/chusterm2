...
<template>
  <div
    ...
    class="z-40 max-w-3xl lg:w-[750px] overflow-visible w-full border border-ui-border-subtle bg-n-alpha-3 backdrop-blur-[100px] shadow-lg rounded-xl p-6 grid gap-6"
  >
    <h3 class="text-base font-medium leading-6 text-n-slate-12">
      {{ filterModalHeaderTitle }}
    </h3>
    <div v-if="props.isFolderView">
      <div class="border-b border-ui-border-subtle/60 pb-6">
        <Input
