...
<template>
  <div
    ...
    class="z-40 grid w-[calc(100vw-2rem)] max-w-3xl gap-6 overflow-visible rounded-xl border border-ui-border-subtle bg-n-alpha-3 p-4 shadow-lg backdrop-blur-[100px] sm:p-6 lg:w-[750px]"
  >
    <h3 class="text-base font-medium leading-6 text-n-slate-12">
      {{ filterModalHeaderTitle }}
    </h3>
    <div v-if="props.isSegmentView">
      <div class="pb-6 border-b border-ui-border-subtle/60">
        <Input
