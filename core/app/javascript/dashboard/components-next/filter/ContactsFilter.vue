...
<template>
  <div
    ...
    class="z-40 grid w-[calc(100vw-2rem)] max-w-3xl gap-6 overflow-visible rounded-xl border border-n-weak bg-n-alpha-3 p-4 shadow-lg backdrop-blur-[100px] sm:p-6 lg:w-[750px]"
  >
