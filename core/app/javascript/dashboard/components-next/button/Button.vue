...
const computedColor = computed(() => {
  ...
  if (attrs.tertiary || attrs.tertiary === '') return 'tertiary';
  return 'primary'; // Default = brand accent (DS tokens)
});
...
const STYLE_CONFIG = {
  colors: {
    ...
    primary: {
      solid:
        'bg-ds-accent text-ds-fg-on-accent hover:enabled:bg-ds-accent-hover focus-visible:bg-ds-accent-hover outline-transparent',
      faded:
        'bg-ds-accent-soft text-ds-accent hover:enabled:bg-ds-accent-soft/80 focus-visible:bg-ds-accent-soft/80 outline-transparent',
      outline:
        'text-ds-accent hover:enabled:bg-ds-accent-soft focus-visible:bg-ds-accent-soft outline-ds-accent',
      link: 'text-ds-accent hover:enabled:underline focus-visible:underline outline-transparent',
      ghost:
        'text-ds-accent hover:enabled:bg-ds-accent-soft focus-visible:bg-ds-accent-soft outline-transparent',
    },
    tertiary: {
      solid:
        'bg-ds-accent-secondary text-ds-fg-on-accent hover:enabled:bg-ds-accent-secondary-hover focus-visible:bg-ds-accent-secondary-hover outline-transparent',
      faded:
        'bg-ds-accent-secondary-soft text-ds-accent-secondary hover:enabled:bg-ds-accent-secondary-soft/80 focus-visible:bg-ds-accent-secondary-soft/80 outline-transparent',
      outline:
        'text-ds-accent-secondary hover:enabled:bg-ds-accent-secondary-soft focus-visible:bg-ds-accent-secondary-soft outline-ds-accent-secondary',
      link: 'text-ds-accent-secondary hover:enabled:underline focus-visible:underline outline-transparent',
      ghost:
        'text-ds-accent-secondary hover:enabled:bg-ds-accent-secondary-soft focus-visible:bg-ds-accent-secondary-soft outline-transparent',
    },
  },
  sizes: {
    regular: {
