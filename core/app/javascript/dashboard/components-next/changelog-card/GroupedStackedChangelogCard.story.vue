...
const sampleCards = [
  {
    id: 'ChusteRM-captain',
    title: 'ChusteRM Captain',
    meta_title: 'ChusteRM Captain',
    meta_description:
      'Watch how our latest feature can transform your workflow with powerful automation tools.',
    slug: 'ChusteRM-captain',
    feature_image:
      'https://www.chusterm.com/images/captain/captain_thumbnail.jpg',
  },
  {
    id: 'smart-routing',
    ...
    slug: 'smart-routing',
    feature_image: 'https://www.chusterm.com/images/dashboard-dark.webp',
  },
  {
    id: 'instant-meetings',
