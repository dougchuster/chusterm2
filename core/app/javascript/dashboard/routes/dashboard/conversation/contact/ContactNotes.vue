...
<template>
  <div>
    ...
    <div
      ...
      class="flex items-center justify-center py-8 text-ds-fg-muted"
      role="status"
    >
      <Spinner />
    </div>
    <div
      ...
      class="flex max-h-[300px] flex-col overflow-y-auto"
    >
      <ContactNoteItem
        v-for="note in notes"
        :key="note.id"
        class="border-ds-border-subtle px-4 py-4 last-of-type:border-b-0"
        :note="note"
    ...
    <p v-else class="px-6 py-6 text-center text-sm leading-6 text-ds-fg-muted">
    ...
    >
      <div class="flex w-full flex-col gap-6 px-6 py-6">
        <h3 class="font-manrope text-lg font-semibold text-ds-fg-default">
