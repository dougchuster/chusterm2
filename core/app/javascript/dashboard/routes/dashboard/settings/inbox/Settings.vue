    ...
    <section class="w-full overflow-auto py-8">
      <div class="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          >
            <div
              class="flex flex-col outline -outline-offset-1 outline-1 outline-ui-border-subtle w-full px-3 pt-3 pb-8 bg-n-surface-1 rounded-2xl min-h-[45rem] overflow-hidden"
            >
              <Widget
