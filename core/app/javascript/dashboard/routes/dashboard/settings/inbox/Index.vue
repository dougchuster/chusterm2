...
<template>
  ...
  >
    ...
    <template #body>
      ...
      <div
        v-else
        class="divide-y divide-ds-border-subtle border-t border-ds-border-subtle"
      >
        <div
        ...
        >
          <div class="flex items-center gap-4 min-w-0">
            <div
              ...
              class="size-10 rounded-lg bg-ds-bg-sunken border border-ds-border-subtle grid place-items-center flex-shrink-0"
            >
              <Avatar
            ...
            <div
              ...
              class="size-10 rounded-lg bg-ds-bg-sunken border border-ds-border-subtle grid place-items-center flex-shrink-0"
            >
              <ChannelIcon class="size-5 text-ds-fg-muted" :inbox="inbox" />
            </div>
            <div class="flex flex-col items-start gap-0.5 min-w-0">
              <span
                class="block text-sm font-medium text-ds-fg-default capitalize truncate"
              >
                {{ inbox.name }}
              </span>
              <ChannelName
