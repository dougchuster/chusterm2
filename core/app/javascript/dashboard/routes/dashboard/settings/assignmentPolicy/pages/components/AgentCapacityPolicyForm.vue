...
<template>
  <form @submit.prevent="handleSubmit">
    <div class="flex flex-col gap-4 mb-2 divide-y divide-ui-border-subtle/60">
      <BaseInfo
    ...
    <div
      ...
      class="flex flex-col gap-4 divide-y divide-ui-border-subtle/60 border-t border-ui-border-subtle/60 mt-6"
    >
      <InboxCapacityLimits
