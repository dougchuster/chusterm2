...
const { currentAccount, isOnChusteRMCloud } = useAccount();
const {
  captainEnabled,
  captainLimits,
  documentLimits,
      ...
      <section class="grid gap-4">
        ...
        >
          ...
          <div
            ...
            class="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-1 gap-2 divide-x divide-ui-border-subtle/60"
          >
            <DetailItem
