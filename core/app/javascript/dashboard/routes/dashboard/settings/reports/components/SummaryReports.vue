...
<template>
  ...
  />
  <div
    class="summary-reports-shell relative flex-1 overflow-auto px-2 py-2 mt-5 shadow outline-1 outline outline-n-container rounded-xl bg-n-solid-2"
  >
    <Table :table="table" />
    <Transition
    ...
    >
      <div
        v-if="isLoading"
        class="summary-reports-loading absolute inset-0 flex justify-center pt-[12.5rem] bg-n-solid-1/70 rounded-xl pointer-events-none"
      >
