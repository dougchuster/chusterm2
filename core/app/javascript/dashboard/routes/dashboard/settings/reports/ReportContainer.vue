...
<template>
  <div
    class="report-metrics-shell grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-6 py-5 shadow outline-1 outline outline-n-container rounded-xl bg-n-solid-2 mt-4"
  >
    <div
      v-for="metric in metrics"
      :key="metric.KEY"
      class="report-metrics-item p-4 mb-3 rounded-md"
    >
      <ChartStats
        :metric="metric"
