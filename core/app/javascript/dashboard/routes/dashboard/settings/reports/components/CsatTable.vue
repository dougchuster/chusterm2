...
const { t } = useI18n();
const { isCloudFeatureEnabled, isOnChusteRMCloud } = useAccount();
...
const showExpandableRows = computed(
  () => isFeatureEnabled.value || isOnChusteRMCloud.value
);
...
<template>
  ...
  >
    ...
    <div
      ...
      class="px-6 py-4 border-t border-ui-border-subtle/60"
    >
