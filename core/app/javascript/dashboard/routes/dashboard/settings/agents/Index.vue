            ...
            <div class="flex flex-col gap-1.5 items-start">
              ...
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <span class="relative" :class="{ group: agent.custom_role_id }">
                  <Badge
                    :label="getAgentRoleName(agent)"
                    variant="neutral"
                    size="sm"
                    :class="{ 'cursor-pointer': agent.custom_role_id }"
                  />
                  <div
                    v-if="agent.custom_role_id"
                    class="absolute ltr:left-0 rtl:right-0 z-10 hidden w-[300px] bg-ds-bg-elevated rounded-xl outline outline-1 outline-ds-border shadow-lg top-8 group-hover:block"
                  >
                    <div class="flex flex-col gap-1 p-4">
                      <span class="text-heading-3 text-ds-fg-default">
                      ...
                      <ul class="ltr:pl-4 rtl:pr-4 mb-0 list-disc">
                        <li
                          ...
                          :key="permission"
                          class="text-body-main text-ds-fg-muted"
                        >
                          {{
                            $t(
