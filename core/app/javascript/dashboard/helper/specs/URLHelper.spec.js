...
describe('#URL Helpers', () => {
  ...
  describe('isValidURL', () => {
    it('should return true if valid url is passed', () => {
      expect(isValidURL('https://chusterm.com')).toBe(true);
    });
  ...
  describe('hasValidAvatarUrl', () => {
    test('should return true for valid non-Gravatar URL', () => {
      expect(hasValidAvatarUrl('https://chusterm.com/avatar.jpg')).toBe(true);
    });
  ...
  describe('getHostNameFromURL', () => {
    ...
    it('should correctly handle URLs with non-standard TLDs', () => {
      expect(getHostNameFromURL('https://chusterm.help')).toBe('chusterm.help');
    });
  });
