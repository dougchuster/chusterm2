...
describe('useAvailability', () => {
  const originalWindow = window.ChusteRMWebChannel;
  ...
  afterEach(() => {
    window.ChusteRMWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.ChusteRMWebChannel changes', () => {
