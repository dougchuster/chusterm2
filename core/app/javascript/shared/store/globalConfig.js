import { parseBoolean } from '@ChusteRM/utils';
...
const {
  ...
  ChusteRM_INBOX_TOKEN: chustermInboxToken,
...
export const getters = {
  get: $state => $state,
  isOnChusteRMCloud: $state => $state.deploymentEnv === 'cloud',
  isACustomBrandedInstance: $state => $state.installationName !== 'ChusteRM',
  isAChusteRMInstance: $state => $state.installationName === 'ChusteRM',
};
