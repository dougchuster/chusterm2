...
export function useBranding() {
  ...
  /**
   * Replaces "ChusteRM" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "ChusteRM" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/ChusteRM/g, installationName);
  };
