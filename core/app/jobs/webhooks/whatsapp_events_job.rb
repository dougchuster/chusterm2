class Webhooks::WhatsappEventsJob < ApplicationJob
  ...
  # ChusteRM and the WhatsApp Business app, with messages synced to ChusteRM.
  #
  ...
  def find_channel_from_whatsapp_business_payload(params)
    ...
    # https://github.com/ChusteRM/ChusteRM/issues/4712#issuecomment-1173838350
  ...
  def get_channel_from_wb_payload(wb_params)
    ...
    Channel::Whatsapp.find_by(phone_number: "+#{display_phone_number}")
  end
end
