...
class InstallationConfig < ApplicationRecord
  ...
  def normalize_llm_config_values
    return unless name.in?(%w[
      ...
      CAPTAIN_MEDIA_AI_MODEL CAPTAIN_AUDIO_TRANSCRIPTION_MODEL CAPTAIN_EMBEDDING_MODEL
    ])
    ...
    elsif name == 'CAPTAIN_OPEN_AI_ENDPOINT'
      self.value = LlmConstants::OPENROUTER_API_ENDPOINT
    end
  end
end
