...
class Campaign < ApplicationRecord
  ...
  validates :scoring_config, jsonb_attributes_length: true
  ...
  has_many :campaign_delivery_events, dependent: :destroy

  store_accessor :scoring_config, :weights, :classification_thresholds, :stage_mapping,
                 :auto_move_on_score, :crm_pipeline_id
  ...
  def validate_campaign_inbox
    ...
    errors.add :inbox, 'Unsupported Inbox type' unless ['Website', 'Twilio SMS', 'Sms', 'Whatsapp', 'Email', 'API'].include? inbox.inbox_type
  end
