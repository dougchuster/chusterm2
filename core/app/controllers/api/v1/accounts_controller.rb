class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_ChusteRM_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_ChusteRM_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless ChusteRMCaptcha.new(params[:h_captcha_client_response]).valid?
  end
