class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'captain' => %w[
        CAPTAIN_OPEN_AI_API_KEY CAPTAIN_ANTHROPIC_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_OPEN_AI_ENDPOINT
        CAPTAIN_MEDIA_AI_API_KEY CAPTAIN_MEDIA_AI_MODEL CAPTAIN_MEDIA_AI_ENDPOINT
        CAPTAIN_AUDIO_TRANSCRIPTION_API_KEY CAPTAIN_AUDIO_TRANSCRIPTION_MODEL CAPTAIN_AUDIO_TRANSCRIPTION_ENDPOINT
