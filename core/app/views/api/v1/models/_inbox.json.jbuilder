...
json.captain_inbox do
  captain_inbox = resource.captain_inbox
  json.enabled captain_inbox&.enabled? || false
  json.auto_reply_enabled captain_inbox&.auto_reply_enabled? || false
  json.ai_mode captain_inbox&.ai_mode
  json.responsible captain_inbox&.responsible? || false
  json.active_for_auto_reply captain_inbox&.active_for_auto_reply? || false
end
